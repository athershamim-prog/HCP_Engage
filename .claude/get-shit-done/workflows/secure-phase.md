...
```
Agent(
  prompt="Read C:/Users/HP/HCP_Engage/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/Users/HP/HCP_Engage/.claude/get-shit-done/templates/SECURITY.md`
