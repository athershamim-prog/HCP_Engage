...
```bash
INIT=$(node "C:/Users/HP/HCP_Engage/.claude/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "C:/Users/HP/HCP_Engage/.claude/get-shit-done/bin/gsd-tools.cjs" commit \
