...
```markdown
Read C:/Users/HP/HCP_Engage/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: C:/Users/HP/HCP_Engage/.claude/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read C:/Users/HP/HCP_Engage/.claude/agents/gsd-ui-checker.md for instructions.
