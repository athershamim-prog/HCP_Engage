...
<reference>
@C:/Users/HP/HCP_Engage/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `C:/Users/HP/HCP_Engage/.claude/get-shit-done/references/user-profiling.md` to load:
